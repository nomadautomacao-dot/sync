...
| 37 | Cobertura vacinal infantil | PNI/DataSUS. Reconhecimento de 2026-07-30: **OpenDataSUS saiu do CKAN** (`/api/3/action/*` devolve o SPA em HTML, não JSON) e **InfoMS/localizaSUS responde 403**. O caminho que resta é o TabNet do PNI ou os arquivos do OpenDataSUS pela navegação nova — não investigado ainda | ◐ | pendente |
