...
| 48 | **Subdeclaração indígena/quilombola — Censo Escolar × Censo Demográfico.** O Censo Escolar registra *declaração* (a escola marcou a cor/raça do aluno e a localização diferenciada); o Censo 2022 mede *população*. Quando a segunda é muito maior que a primeira, a lacuna é de **registro**, e como indígena e quilombola ponderam de 1,4 a 2,17 — os maiores fatores da tabela — cada matrícula não declarada é receita perdida todo exercício. Exemplo que motivou o item: Manaus aparece com ~1% de matrícula indígena. Fontes: `escolas-territorio.json` (cor/raça por escola, já local) × SIDRA 8175/8176/10089 (população indígena e quilombola por idade). **Regra dura:** pertencimento étnico é autodeclaração — a página aponta lacuna de registro e nunca rotula pessoas | ◐ | pendente |
| 46 | Radar de imprensa local (12 meses), marcado como indício a confirmar | busca + IA | ✦ | pendente |
| 47 | Roteiro de campo dinâmico ampliado para os blocos novos | template | ● | pendente |
