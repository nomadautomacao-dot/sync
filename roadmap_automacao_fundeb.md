...
- `scripts/build-inep-censo-municipal-dataset.py` funde sinopse municipal e microdados de escola `2023`, `2024` e `2025`.
...
- **Infraestrutura INEP:** `scripts/build-inep-censo-municipal-dataset.py`
