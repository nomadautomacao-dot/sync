...
void main() {
  ...
  test('gera PDF lite do levantamento FUNDEB', () async {
    ...
    final bytes = await FundebLevantamentoPdfBuilder.buildLiteFromBundle(
      bundle,
    ...
    await File('build/fundeb_lite_test.pdf').writeAsBytes(bytes);
  });
}
